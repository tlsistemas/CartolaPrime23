...
const buttonSecondaryColor = Color(0xFFBFE8FF);
const primaryLightColor = Color(0xFFBFE8FF);
const colorPrimaryDark = Color(0xFF000000);
const colorAccent = Color(0xFF000000);
const iconColorPrimary = Color(0xFFFFFFFF);
const textColorPrimary = Color(0xFFFFFFFF);
const textColorSecondary = Color(0xFF273238);
